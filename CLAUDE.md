...
- Hero image position: `object-position: 68% 32%`（640px以下は `53% 14%` で顔を右上に寄せる）
- Hero h1 is a calligraphy image (`calligraphy-hero.png`, width `min(560px, 85vw)`, alt に全文)
- Mobile hero (640px以下): 住所3行と「料金を見る」ボタンを非表示にし、「予約する」1本に絞る
